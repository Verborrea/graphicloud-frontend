<script lang="ts">
	...
	import FileDropper from '$lib/components/old/FileDropper.svelte';
	import DocumentResult from '$lib/components/old/DocumentResult.svelte';
	import DocumentMap from '$lib/components/old/DocumentMap.svelte';
	import LoadingBar from '$lib/components/old/LoadingBar.svelte';
